<link href="css/admin/plugins/identityimport/timeline.css" rel="stylesheet" />
<#--<#assign description>-->
<#--  <#if current_rule_code??>-->
<#--    <#list duplicate_rule_list as rule>-->
<#--      <#if rule.code == current_rule_code>-->
<#--        #i18n{identityimport.search_history_ruleFilter} <strong>${rule.name}</strong><br>-->
<#--        <#if rule.duplicateCount gt 0>-->
<#--          <@pageColumnBtn class="mt-2" hideSize="xxl" title="${rule.duplicateCount} #i18n{identityimport.search_duplicates.pageTitle}" idPageColumn="mediation-duplicate-list" />-->
<#--        </#if>-->
<#--      </#if>-->
<#--    </#list>-->
<#--  <#else>-->
<#--    #i18n{identityimport.search_history_ruleFilter.all}   -->
<#--  </#if>-->
<#--</#assign>-->
...
<#--      <@pageColumnBtn class="mb-3" hideSize="xxl" title="#i18n{identityimport.search_duplicates.pageTitle}" idPageColumn="mediation-duplicate-list" />-->
<#--    </#if>-->
    ...
    <div class="jumbotron jumbotron-fluid text-center pb-4">
      <div class="col-7 mt-5 mb-3 card bg-secondary p-5 rounded-5 shadow-none" style="margin:0 auto">
        ...
        <h1 class="mt-3">#i18n{identityimport.search_history.noActivity}</h1>
<#--        ${description}-->
      </div>
    </div>
  </@pageColumn>
...
<#--        <#assign title><i class="ti ti-activity"></i> #i18n{identityimport.search_history.pageTitle}</#assign>-->
...
<#--                    <#else>N/A</#if>-->
<#--                  </h3>-->
<#--                  <p class="m-0">#i18n{identityimport.search_history.modify} <strong>${attributeChanges[0].authorName!"N/A"}</strong> - #i18n{identityimport.search_history.type} : <strong>${attributeChanges[0].authorType!"N/A"}</strong></p>-->
<#--                  <div class="mt-3 mb-0">-->
